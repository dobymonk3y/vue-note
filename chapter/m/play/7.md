...
5. stroke-dasharray ：描边周长
6. stroke-dashoffset：覆盖的周长
7. stroke ： 描边的颜色
...
比如：上面定义的圆半径为50，那么这个圆的周长stroke-dasharray = π*直径 = π*100 ≈ 314， 这个时候 stroke-dashoffset 就相当于定义了 描边的周长具体是多少，比如设置为100，那么就如同一个进度条一样，在314步中已经走了100步
